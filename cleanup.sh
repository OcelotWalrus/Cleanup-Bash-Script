...
settings_line1=$(sed -n 2p settings.yaml)
settings_line2=$(sed -n 3p settings.yaml)
settings_line3=$(sed -n 4p settings.yaml)
settings_line4=$(sed -n 5p settings.yaml)
settings_line5=$(sed -n 6p settings.yaml)
settings_line6=$(sed -n 7p settings.yaml)
settings_line7=$(sed -n 8p settings.yaml)
settings_line8=$(sed -n 9p settings.yaml)
settings_line9=$(sed -n 10p settings.yaml)
settings_line10=$(sed -n 11p settings.yaml)
settings_line11=$(sed -n 12p settings.yaml)
settings_line12=$(sed -n 13p settings.yaml)
settings_line13=$(sed -n 14p settings.yaml)
settings_line14=$(sed -n 15p settings.yaml)
